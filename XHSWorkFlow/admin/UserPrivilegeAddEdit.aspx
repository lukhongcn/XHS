                ...
                <div id="Content">
                     <div id="Menu">
                         <div class="menubox">
                             <div class="mod1">
                                 <ul>
                                     <li class="btn5"><a href="UserPrivilegeList.aspx" title="查看 / view">查看/view</a>
                                     </li>
                                     <li class="btn3">
                                         <asp:LinkButton ID="lnkbutton_edit" runat="server" ToolTip="保存/save" OnClick="lnkbutton_save_Click">保存/save</asp:LinkButton>
                                     </li>
                        ...
                        <div class="container mt-3">
                                <div class="row mb-3">
                                     <div class="col-lg-12  d-flex">
                                        <asp:Label ID="Label2" runat="server" CssClass="me-10">员工编号:</asp:Label>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Textbox_UserId" ErrorMessage="请输入员工编号"></asp:RequiredFieldValidator>
                                        <asp:Label ID="Label3" runat="server" CssClass="me-10">密码:</asp:Label>
                                        ...
                                        <asp:RequiredFieldValidator ID="Requiredfieldvalidator3" runat="server" ControlToValidate="Textbox_Password" ErrorMessage="请输入密码"></asp:RequiredFieldValidator>
                                        <asp:DropDownList ID="DropDownList_Role" runat="server" Visible="False"></asp:DropDownList>
                                    </div>
                                </div>
                             <div class="row mb-3">
                                 <div class="col-lg-12  d-flex">
                                        <asp:Label ID="Label4" runat="server"  CssClass="me-10">模块:</asp:Label>
                                        ...
                                        <asp:Label ID="Label5" runat="server"  CssClass="me-10">子模块:</asp:Label>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-12  d-flex">
                                        <asp:DataGrid ID="DataGridPrivate" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover table-sm" style="table-layout:fixed;width: 100%;">
                                            ...
                                            <Columns>
                                                <asp:BoundColumn DataField="menuid" HeaderText="功能项"></asp:BoundColumn>
                                                <asp:BoundColumn DataField="menuname" HeaderText="功能项描述"></asp:BoundColumn>
                            ...
                            <div class="row mb-3">
                                    ...
                                    <div class="col-lg-6 d-flex">
                                        <asp:DataGrid ID="dg_column" runat="server" AutoGenerateColumns="False" OnItemDataBound="dg_column_DataBinding" CssClass="table table-striped table-bordered table-hover table-sm">
                                           ...
                                           <Columns>
                                               ...
                                               <asp:BoundColumn DataField="MenuName" HeaderText="模块"></asp:BoundColumn>
                                               <asp:BoundColumn DataField="TableValue" HeaderText="内容"></asp:BoundColumn>
                                           </Columns>
                                       </asp:DataGrid>
                                    </div>
                                ...
                                <div class="row mb-3">
                                     <div class="col-lg-1 d-flex">
                                        <asp:Label ID="Label9" runat="server" CssClass="me-10">系统管理员</asp:Label>
                                     </div>
