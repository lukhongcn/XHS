...
namespace ModuleWorkFlow.admin
{
    ...
    public class UserPrivilegeAddEdit : System.Web.UI.Page
    {
        ...
        private void bindSubMenu()
        {
            ...
            drp_subMenu.Items.Insert(0, new ListItem("所有", drp_menu.SelectedValue));
        ...
        private void bindParentMenu()
        {
            ...
            drp_menu.DataBind();
            drp_menu.Items.Insert(0, new ListItem("所有", "0"));
        ...
        private void BindMenu(string username)
        {
            ...
            if (ip.Count == 0)
            {
                ...
                if (ui == null)
                {
                    Label_Message.Text = "用户已删除，请重新选择";
                    return;
                }
        ...
        private void InitalEditPage(string userid)
        {
            ...
            if (dr != null)
            {
                ...
                .Select(p => new
                {
                    ...
                    JobGroupName = string.IsNullOrEmpty(p.JobGroup) ? "其他" : p.JobGroupName,
                    ProcessInfo = p
                })
