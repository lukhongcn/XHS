    ...
    <div id="Wrapper">
        ...
        <div id="Container"><div id="Content">
            ...
            <div class="container mt-3 border border-primary"><div class="container mt-3">
                ...
                <div class="row mb-3"><div class="col-lg-6 d-flex"><asp:Label ID="Label_KdPartName" runat="server" CssClass="me-10 delivery-label" AssociatedControlID="txt_KdPartName">零件名称</asp:Label><asp:TextBox ID="txt_KdPartName" runat="server" CssClass="form-control text-start border-primary delivery-readonly" ReadOnly="true"></asp:TextBox></div></div>
