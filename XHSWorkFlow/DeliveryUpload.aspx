    ...
    <div id="Wrapper">
        ...
        <div id="Container"><div id="Content">
            ...
            <div class="container mt-3 border border-primary"><div class="container mt-3">
                ...
                <div class="row mb-3"><div class="col-lg-6 d-flex"><asp:Label ID="Label_DeliveryQty" runat="server" CssClass="me-10 delivery-label" AssociatedControlID="txt_DeliveryQty">数量</asp:Label><asp:TextBox ID="txt_DeliveryQty" runat="server" CssClass="form-control text-start border-primary delivery-readonly" ReadOnly="true"></asp:TextBox></div><div class="col-lg-6 d-flex"><asp:Label ID="Label_SxCardSeq" runat="server" CssClass="me-10 delivery-label" AssociatedControlID="txt_SxCardSeq">随箱卡流水号</asp:Label><asp:TextBox ID="txt_SxCardSeq" runat="server" CssClass="form-control text-start border-primary packing-required" AutoPostBack="true" OnTextChanged="txt_SxCardSeq_TextChanged"></asp:TextBox></div></div>
