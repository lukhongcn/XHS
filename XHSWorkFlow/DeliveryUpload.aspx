    ...
    <div id="Wrapper">
        ...
        <div id="Container"><div id="Content">
            ...
            <div class="container mt-3 border border-primary"><div class="container mt-3">
                ...
                <div class="row mb-3"><div class="col-lg-6 d-flex"><asp:Label ID="Label_DeliveryPackageCode" runat="server" CssClass="me-10 delivery-label" AssociatedControlID="txt_DeliveryPackageCode">包装单编号</asp:Label><asp:TextBox ID="txt_DeliveryPackageCode" runat="server" CssClass="form-control text-start border-primary delivery-readonly" ReadOnly="true"></asp:TextBox></div><div class="col-lg-6 d-flex"><asp:Label ID="Label_DeliveryPackageName" runat="server" CssClass="me-10 delivery-label" AssociatedControlID="txt_DeliveryPackageName">包装名称</asp:Label><asp:TextBox ID="txt_DeliveryPackageName" runat="server" CssClass="form-control text-start border-primary delivery-readonly" ReadOnly="true"></asp:TextBox></div></div>
                <div class="row mb-3"><div class="col-lg-6 d-flex"><asp:Label ID="Label_DeliveryNo" runat="server" CssClass="me-10 delivery-label" AssociatedControlID="txt_DeliveryNo">配送单号</asp:Label><asp:TextBox ID="txt_DeliveryNo" runat="server" CssClass="form-control text-start border-primary delivery-readonly" ReadOnly="true"></asp:TextBox></div></div>
