...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" runat="server">
    ...
    <div id="Wrapper">
        ...
        <div id="Container"><div id="Content">
            <div id="Menu"><div class="menubox"><div class="mod1"><ul><li class="btn5"><asp:LinkButton ID="lnk_view" runat="server" OnClick="lnk_view_Click" ToolTip="浏览">浏览</asp:LinkButton></li><li class="btn13"><asp:LinkButton ID="lnkbutton_upload" runat="server" OnClick="lnkbutton_upload_Click" ToolTip="上传" Enabled="false">上传</asp:LinkButton></li></ul></div><div class="clearbox"></div></div></div>
            ...
            <div class="container mt-3 border border-primary"><div class="container mt-3">
                ...
                <div class="row mb-3"><div class="col-lg-12 d-flex"><asp:RadioButtonList ID="rblScanType" runat="server" RepeatDirection="Horizontal" CssClass="delivery-scan-type"><asp:ListItem Value="KD" Selected="True">KD 标签</asp:ListItem><asp:ListItem Value="Packing">配送单</asp:ListItem></asp:RadioButtonList></div></div>
