    ...
    <div id="Wrapper">
        ...
        <div id="Container"><div id="Content">
            ...
            <div class="container mt-3 border border-primary"><div class="container mt-3">
                ...
                <div class="row mb-3"><div class="col-lg-12 d-flex justify-content-center"><asp:Button ID="btn_packing_complete" runat="server" Text="装箱完成" CssClass="btn btn-primary" OnClick="btn_packing_complete_Click" Enabled="false" /></div></div><asp:HiddenField ID="hidPackingId" runat="server" /><asp:HiddenField ID="hidLockToken" runat="server" /><asp:HiddenField ID="hidPackingCompleteMode" runat="server" />
            </div></div>
...
<asp:Content ID="Content2" ContentPlaceHolderID="JSHolder" runat="server">
    <style>.packing-label{min-width:110px;line-height:30px}.packing-scan{width:100%}.packing-required{background-color:#fff59d!important}.packing-readonly{background-color:#f3f3f3!important}.packing-scan-type label{margin-right:24px}.packing-scan-type input[type='radio']:disabled + label,.packing-radio-disabled{display:inline-block;padding:0;border:0;background-color:transparent!important;color:#b3b3b3!important;font-weight:700;opacity:1;cursor:not-allowed}.packing-scan-type input[type='radio']:disabled{filter:grayscale(1);opacity:.65}.packing-radio-enabled{color:black!important}.packing-lock-panel{position:fixed;inset:0;z-index:10000;align-items:center;justify-content:center;background:rgba(0,0,0,.45);color:#842029;padding:16px;font-size:18px}.packing-lock-card{min-width:360px;max-width:720px;padding:32px;text-align:center;border:1px solid #dc3545;border-radius:6px;background:#fff3cd;box-shadow:0 8px 24px rgba(0,0,0,.25);line-height:1.8}</style>
